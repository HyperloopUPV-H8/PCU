...
TimerPeripheral timer1(&htim1, {ADVANCED, 5, 55000, 400}, "TIM 1");
TimerPeripheral timer2(&htim2, {BASE, 5, 55000, 400}, "TIM 2");
TimerPeripheral timer3(&htim3, {ADVANCED, 5, 55000, 400}, "TIM 3");
TimerPeripheral timer4(&htim4, {ADVANCED, 5, 55000, 400}, "TIM 4");
TimerPeripheral timer12(&htim12, {ADVANCED, 5, 55000, 400}, "TIM 12");
TimerPeripheral timer16(&htim16, {BASE, 5, 55000, 400}, "TIM 16");
TimerPeripheral timer17(&htim17, {BASE, 5, 55000, 400}, "TIM 17");
TimerPeripheral timer15(&htim15, {ADVANCED, 5, 55000, 400}, "TIM 15");
